          ...
          <div className="min-h-screen bg-background text-foreground">
            ...
            >
              ...
              <div className="hidden lg:flex items-center gap-4 flex-1 max-w-lg mx-8">
                ...
                <div
                  ref={searchRef}
                  className="hidden lg:flex items-center gap-3 flex-1 max-w-sm mx-8 relative"
                >
                  <div
                  ...
                  {searchFocused && searchResults && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-background/95 backdrop-blur-xl border border-foreground/20 rounded-2xl shadow-2xl z-100 overflow-hidden max-h-80 overflow-y-auto">
                      {/* Usuarios */}
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-foreground/20 border border-foreground/30 flex items-center justify-center text-sm font-black text-foreground uppercase">
            ...
            <main className="max-w-6xl mx-auto px-6 py-20 space-y-20">
              ...
              <section>
                ...
                {actividadAmigos.length === 0 ? (
                  <div className="text-center py-10 bg-foreground/5 border border-foreground/10 rounded-2xl">
                    <p className="text-foreground/40 text-sm">
                      Aún no sigues a nadie o tus amigos no tienen actividad
                      reciente.
                    </p>
                    <Link
                      href="/buscar"
              ...
              >
                ...
                <section>
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <a
                      href="#"
                      className="text-sm font-semibold text-foreground/80 hover:text-foreground transition-colors duration-200"
                    >
                      Ver todo →
                    </a>
                  </div>
                ...
                <section>
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <a
                      href="#"
                      className="text-xs font-semibold text-foreground/50 tracking-widest uppercase hover:text-foreground transition-colors cursor-pointer"
                    >
                      Ver todo →
                    </a>
                  </div>
