...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      {/* ── FEATURES ── */}
      <section id="características" className="relative z-10 px-6 py-20 max-w-5xl mx-auto w-full">
        <RevealSection>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <RevealSection key={title} delay={i * 80} direction="up">
              <div className="bg-foreground/5 border border-foreground/10 rounded-2xl p-6 hover:border-foreground/25 hover:-translate-y-1 transition-all duration-200 cursor-default h-full">
      ...
      <section id="trending" className="relative py-20 border-y border-foreground/10 overflow-hidden">
        ...
        {/* Dome + panel flotante */}
        <RevealSection delay={200} direction="up" className="relative z-10" style={{ height: "500px" }}>
