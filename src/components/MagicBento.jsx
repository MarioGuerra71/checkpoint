          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-cyan-300">
            ...
            return (
              ...
              >
                <div className="card__header flex justify-between gap-3 relative">
                  <span
                    className="card__label text-[10px] font-black uppercase tracking-[0.2em] opacity-60"
                ...
                <div className="card__content flex flex-col relative">
                  <h3
                    className="card__title font-black m-0 mb-2 leading-none"
                    style={{
                  ...
                  <p
                    className={`card__description text-xs leading-relaxed opacity-50 ${textAutoHide ? "text-clamp-2" : ""}`}
                    style={{ color: "var(--white)" }}
                  >
                    {card.description}
                  </p>
